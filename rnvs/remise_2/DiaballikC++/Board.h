...
#include <vector>
#include "Piece.h"
// #include "Players.h" // rnvs : comm

#include <ostream>  // rnvs : ajout

using namespace std;
using namespace PieceSpace;
//using namespace PlayersSpace; // rnvs : comm

namespace PlayersSpace      // rnvs : ajout
{// rnvs : ajout
class Players;  // rnvs : ajout
}   // rnvs : ajout
...
class Board
{
  ...
  public:
     ...
     */
    // void passe(int dx, int dy, Players currentPlayer);   // rnvs : comm
    void passe(int dx, int dy, PlayersSpace::Players currentPlayer);// rnvs : ajout
